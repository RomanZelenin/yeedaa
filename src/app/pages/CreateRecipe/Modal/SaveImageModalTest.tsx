...
export type SaveImageModalTestProps = {
    image?: string;
    isOpen?: boolean;
    onDelete: () => void;
    onClose: () => void;
    onSave: (img: string | ArrayBuffer | null) => void;
...
export const SaveImageModalTest = ({ isOpen = false, ...props }: SaveImageModalTestProps) => {
    ...
    return (
        <Modal onClose={() => props.onClose()} isOpen={isOpen} isCentered>
            <ModalOverlay />
